<?php
    ...
    class GroupementStations {
        ...
        function __construct () {
            ...
            if(!is_dir($CheminVersData2Global)) { // On essaye en ../data si le chemin actuel n'est pas bon, fonctionnera si on est dans un répertoire enfant
                $CheminVersData2Global = "../data/";
                $CheminVersData2 = $CheminVersData2Global."TempsReel/";
            }
        ...
        */
        public function getAppartenanceGroupe(int $num,int $groupe) {
            return(((object) $this->tab_appartenance[$groupe])->$num*100);
        }
