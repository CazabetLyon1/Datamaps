...
class Statistiques_stations {
    ...
    function __construct () {
        // Réglage de la variable menant au data
        global $CheminVersDossierData;
        if(!is_dir($CheminVersDossierData)) // On essaye en ../data si le chemin actuel n'est pas bon, fonctionnera si on est dans un répertoire enfant
            $CheminVersDossierData = "../data/";
    }
